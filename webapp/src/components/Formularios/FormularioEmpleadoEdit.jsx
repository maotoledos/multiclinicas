...
import { editarEmpleado } from '../../ActionState/empleados/api/actions';
...
tipousuarioId:''
 ...
 componentWillMount() {
    let empleado = this.props.valores;
    this.setState({
    id:empleado.id,
    ...
    first_users: empleado.first_users, 
    fechanacimiento:empleado.fechanacimiento,
    estadocivil:empleado.estadocivil,
    nacionalidad:empleado.nacionalidad,
    domicilio:empleado.domicilio,
    ocupacion:empleado.ocupacion,
    sucursaleId: empleado.sucursaleId,
   tipousuarioId:empleado.tipousuarioId
    })
 }
...
export default connect(mapStateToProps, { editarEmpleado })(FormularioEmpleado);