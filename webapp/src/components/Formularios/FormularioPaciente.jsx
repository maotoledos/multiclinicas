...
import { agregarPaciente } from '../../ActionState/pacientes/api/actions';
...
class LoginForm extends Component {
 ...
 onSubmit(event) {
  ...
  this.props.agregarPaciente(this.state)
  this.setState({
   bloquear:true
  })
 }
...
export default connect(mapStateToProps, { agregarPaciente })(LoginForm);